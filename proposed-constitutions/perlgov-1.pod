=head1 Perl Rules of Governance
...
Condorcet Minimax method.  If a tie occurs, it may be resolved by mutual
agreement among the tied candidates, or else the tie will be resolved through
random selection by the Vote Administrator.
